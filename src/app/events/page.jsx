              ...
              <div class="event-block even">
                <div class="row">
                  ...
                  <div class="col-lg-5 sec-2 border-class-here">
                    <img src="Speakers Session 2.png" />
                  </div>
                    ...
                    <div class="time">
                      <table>
                        <tr>
                          ...
                          <td>
                            <div>Sept 8 , 2023 , from 6 PM to 8 PM</div>
                    ...
                    <div class="time">
                      <table>
                        <tr>
                          ...
                          <td>
                            <div>06:00PM [Sept 9] To 06:00PM [Sept 10]</div>
                            <div class="dim-color"></div>
                          </td>
                        </tr>
                      </table>
            ...
            <div class="upcoming-event-list">
              <div class="event-block odd">
                <div class="row">
                  ...
                  <div class="col-lg-5 sec-2 border-class-here">
                    <img src="Speakers Session 1.png" />
                  </div>
                  <div class="col-lg-5 sec-3">
                    <div class="title">Speaker's session</div>
                    <div class="venue">
                    ...
                    <div class="time">
                      <table>
                        <tr>
                          ...
                          <td>
                            <div>Sept 10, 2023, from 06:30PM to 8:00PM</div>
                            <div class="dim-color"></div>
                          </td>
                        </tr>
                      </table>
                    ...
                    <ul class="w-full flex flex-col text-gray-700 list-none p-0 font-thin text-left">
                      <li>
                        <a
                          ...
                          class="inline-block py-2 pl-3 pr-5 hover-effect no-underline text-left"
                          target="_blank"
                        >
                          About
                        </a>
