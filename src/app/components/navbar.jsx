          ...
          <div className="navbar-css h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img
                  className="h-10 w-10 no-underline"
              ...
              <div className="hidden md:block ">
                <div className="ml-10 flex items-baseline space-x-5 h-fit">
                  ...
                  <a
                    className="flex flex-row items-center bg-slate-500 hover:bg-slate-300 hover:text-slate-800 py-2 px-3 rounded-md justify-center no-underline"
                    href="#"
                  >
                    <img
                      src="/file.png"
          ...
          {(ref) => (
            <div className="md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a
                  className="flex flex-row items-center bg-slate-500 py-2 px-3 rounded-md justify-center w-[8rem] hover:bg-slate-300 hover:text-slate-800 no-underline"
                  href="#"
                >
                  <img
                    src="/file.png"
